 ...
 */
public class DecodeThreadFragment extends Thread {
	...
	public DecodeThreadFragment(ScanBarFragment fragment, int decodeMode) {
	...
	public void run() {
		Looper.prepare();
		handler = new DecodeHandlerFragment(mScanBarFragment, hints);
